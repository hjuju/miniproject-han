...
export const BlogMenu = () => (<nav>
    <ol>
        ...
        <li><Link to='/blog-register'>게시글 쓰기</Link></li>
        <li><Link to='/blog-retrive'>게시글 조회</Link></li>
        <li><Link to='/blog-update'>게시글 수정</Link></li>
        <li><Link to='/blog-delete'>회원정보삭제</Link></li>
    </ol>
</nav>
)
